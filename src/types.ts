...
export const RESULTS = ['checkmate', 'stalemate', 'draw', 'bareking', 'kinglost', 'lastmanstanding'] as const;
export type Result = (typeof RESULTS)[number];

export const RULES = ['standard', 'minishogi', 'chushogi', 'annanshogi', 'kyotoshogi', 'hasamishogi'] as const;
