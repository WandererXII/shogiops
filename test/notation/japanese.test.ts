...
test('corect drop amb resolution', () => {
  ...
  const pos = setupPosition('standard', setup).unwrap();
...
test('corect move amb resolution', () => {
  ...
  const pos2 = setupPosition('standard', setup2).unwrap();
  ...
  const pos3 = setupPosition('standard', setup3).unwrap();
  ...
  const pos4 = setupPosition('standard', setup4).unwrap();
  ...
  const pos5 = setupPosition('standard', setup5).unwrap();
...
test('中 amb resolution', () => {
  ...
  const pos1 = setupPosition('standard', setup1).unwrap();
