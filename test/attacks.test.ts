import { rookAttacks, bishopAttacks, knightAttacks, kingAttacks, silverAttacks, goldAttacks, lanceAttacks, horseAttacks, dragonAttacks, ray, between } from '../src/attacks';
...
test('rook attacks', () => {
  ...
  expect(rookAttacks(center, new SquareSet(0x40401, 0x4c25108, 0x77a0100))).toEqual(new SquareSet(0x402010, 0x405010, 0x0));
  ...
  expect(rookAttacks(cornerLast, new SquareSet(0x0, 0x100, 0x3fc0000))).toEqual(new SquareSet(0x0, 0x4020100, 0x2020100));
  expect(rookAttacks(cornerLast, new SquareSet(0x0, 0x20000, 0x2010000))).toEqual(new SquareSet(0x0, 0x4020000, 0x2020100));

  expect(rookAttacks(71, new SquareSet(0x1110501, 0xa00028, 0x4050444))).toEqual(new SquareSet(0x4020100, 0x4020100, 0x4010100));
});
...
test('lance attacks', () => {
	...
	expect(lanceAttacks("black", 15, new SquareSet(0x0, 0x814480, 0xe020))).toEqual(new SquareSet(0x1000000, 0x1008040, 0x8040));
