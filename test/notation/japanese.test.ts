...
test('corect drop amb resolution', () => {
  const setup = parseFen('k7K/9/9/9/9/9/S8/8g/9 b SPg 1').unwrap();
...
test('corect move amb resolution', () => {
  const setup = parseFen('k7K/9/9/9/9/9/2G6/3G5/2G6 b - 1').unwrap();
  const pos = setupPosition('shogi', setup).unwrap();
  ...
  const setup2 = parseFen('3k1K3/9/9/5B3/9/9/9/1B7/9 b - 1').unwrap();
  ...
  const setup3 = parseFen('3k1K3/9/9/3S1S3/9/3S1S3/9/9/9 b - 1').unwrap();
  ...
  const setup4 = parseFen('3k1K3/9/9/9/9/3GGG3/9/9/9 b - 1').unwrap();
  ...
  const setup5 = parseFen('3k1K3/9/9/9/9/9/3+B+B4/9/9 b - 1').unwrap();
...
test('corect move amb resolution - gote pov', () => {
  ...
  const setup4 = parseFen('3k1K3/9/9/9/9/3ggg3/9/9/9 w - 1').unwrap();
  const pos4 = setupPosition('shogi', setup4).unwrap();
  ...
  const setup5 = parseFen('3k1K3/9/9/9/9/9/3+b+b4/9/9 w - 1').unwrap();
  const pos5 = setupPosition('shogi', setup5).unwrap();
...
test('中 amb resolution', () => {
  const setup1 = parseFen('3k1K3/9/9/9/3+B+B+B3/9/3+B+B+B3/9/9 b - 1').unwrap();
  ...
  const setup2 = parseFen('3k1K3/9/9/9/9/9/3+B+B+B3/9/9 b - 1').unwrap();
  const pos2 = setupPosition('shogi', setup2).unwrap();
